...
import { TOSS_CLIENT_KEY } from '../../utils/constants'

const customerKey = 'Yx7XT1wRZfCU-HdkPTbzk'
...
const TossCheckout = () => {
  ...
  return (
    ...
    <Container>
      ...
      <PayButton className='button' onClick={() => requestPayment()}>
        {`${amount}원 결제하기`}
      </PayButton>
    </Container>
  )
