...
export const TOSS_BASE_URL = import.meta.env.VITE_TOSS_BASE_URL
export const TOSS_AUTH_BASE_URL = import.meta.env.VITE_TOSS_AUTH_BASE_URL
export const TOSS_REDIRECT_URI = import.meta.env.VITE_TOSS_REDIRECT_URI
