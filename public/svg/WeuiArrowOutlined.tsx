...
export function WeuiArrowOutlined(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={20} height={40} viewBox='0 0 12 24' {...props}>
      <defs>
        <path
      ...
      <use fillRule='evenodd' href='#weuiArrowOutlined0' transform='rotate(-180 5.02 9.505)'></use>
    </svg>
  )
}
